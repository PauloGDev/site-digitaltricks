    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <Suspense fallback={<RouteFallback />}>
        <Routes>
          ...
          <Route path="/websites" element={<Navigate to="/solucoes/sites" replace />} />
          <Route path="/ecommerce" element={<Navigate to="/solucoes/sites" replace />} />
          ...
          <Route path="/marketing" element={<Navigate to="/solucoes/marketing" replace />} />
